...
public class EventEnemy : enemy
{
    ...
    //the hostage either kid who joined bandits or classic
    //well the classic would be before and maybe after
    //the kid would be just after

    //so maybe a variable for the time when the event is triggered
    //maybe the event itself
